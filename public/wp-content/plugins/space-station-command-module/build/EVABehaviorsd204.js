...
window.EVASuit.Behaviors.Behavior = function(Element, Document, Behaviors) {
    ...
    class Behavior {
        ...
        static locate(elem, ...objectArgs) {
            ...
            } else if (elem.length !== undefined && elem.length > 0) { //jQuery-like element
